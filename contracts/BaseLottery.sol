...
contract BaseLottery is Manageable {
    ...
    function setRoundParticipants(uint _round, uint _participants) public {
        rounds[_round].participantCount = _participants;
    }
    ...
    function setStartRoundTime(uint _round, uint _time) public {
        rounds[_round].startRoundTime = _time;
    }

    function setRoundState(uint _round, uint _state) public {
        rounds[_round].state = RoundState(_state);
    }
